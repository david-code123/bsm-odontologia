...
const socials = [
  {
    ...
    svg: <IgIcon id="ig-grad-clinic" />,
  },
  {
    label: '@drbrunobronson',
    sublabel: 'Dr. Bruno',
    href: 'https://www.instagram.com/drbrunobronson/',
    svg: <IgIcon id="ig-grad-dr" />,
  },
  {
    label: 'WhatsApp',
    sublabel: '(62) 99355-7723',
    href: WA_LINK,
    svg: (
        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-brand-text">
              Transformando vidas com naturalidade, segurança e cuidado em cada detalhe.
            </p>
              ...
              {socials.map(s => (
                ...
                >
                  ...
                  <span className="footer-social-text">
                    <span className="footer-social-handle">{s.label}</span>
                    <span className="footer-social-sub">{s.sublabel}</span>
                  </span>
                </a>
              ))}
            </div>
